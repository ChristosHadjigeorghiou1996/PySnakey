...
class Food:
    def __init__(self, position: MapPosition, grid_dimensions: Tuple[int, int]):
        self.position = position
        self.grid_dimensions = grid_dimensions

    def respawn(self):
        self.position = (MapPosition(random.randint(0, self.grid_dimensions[0] - 1),
                                     random.randint(0, self.grid_dimensions[1] - 1)))
